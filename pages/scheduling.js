...
Home.getInitialProps = async ({ query }) => {
  ...
  const locationMapping = [
    ...
    },
    {
      ...
      link:
        'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=79108&vt=2228&dept=100001324&view=plain&public=1'
    },
    {
      name: 'Avalon Health Center Testing',
      link:
        'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=79471&vt=2228&dept=100001346&view=plain&public=1'
    },
    {
      name: 'Bayview Mass Testing',
      link:
        'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=79223&vt=2228&dept=100001333&view=plain&public=1'
    },
    {
      name: 'Branford Hills Mass Testing',
      link:
        'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=79156&vt=2228&dept=100001328&view=plain&public=1'
    },
    {

...
Home.getInitialProps = async ({ query }) => {
  ...
  const urlList = {
    'Fairfield County and NY': {
      ...
      SymptomaticFive:
        'https://openscheduling.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=78600,85142,76703&vt=2228&dept=103010119,100001384,104010098&view=plain&public=1',
      AsymptomaticFive: {
        mandate:
    ...
    'New London County': {
      ...
      SymptomaticFive:
        'https://openscheduling.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=76701,82949&vt=2228&dept=108010101,100001383&view=plain&public=1',
      AsymptomaticFive: {
        mandate:
          'https://openscheduling.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=76701,82949&vt=2102&dept=108010101,100001383&view=plain&public=1',
        travel:
    ...
    'New Haven County and Middlesex County': {
      ...
      SymptomaticFive:
        'https://openscheduling.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=81079,88751,81452,82383,82948&vt=2228&dept=103720003,101130001,100001365,101050022,100001382&view=plain&public=1',
      AsymptomaticFive: {
        mandate:

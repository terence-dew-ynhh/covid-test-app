...
Home.getInitialProps = async ({ query }) => {
  ...
  const urlList = {
    'Fairfield County and NY': { 
      'Symptomatic': 'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/standalone?id=78600,85142,76703,76698&vt=2276&dept=103010119,100001384,104010098,103010119&view=plain&public=1',
    ...
    'New Haven County and Middlesex County': {
      'Symptomatic': 'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/standalone?id=81079,88751,81452,82383,82948&vt=2276&dept=103720003,101130001,100001365,101050022,100001382,102430001&view=plain&public=1',

...
Home.getInitialProps = async ({ query }) => {
  ...
  const locationMapping = [
    ...
    },
    {
      ...
      link:
        'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=79287,79288,79289,82068,82088&vt=2228&dept=100001341&view=plain&public=1'
    },
    {

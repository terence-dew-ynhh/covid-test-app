...
const OutOfWorkConsent = ({ nextPage, isPrevEnabled, isDoneEnabled, schedulePush }) => {
    ...
    <>
      <div className={styles.question_row_item}>
        ...
        <div className={styles.question_row_item_sub}>
          <fieldset>
            <legend>
            You are out of work for 48 or more hours pending a test result and clearance from Occupational Health

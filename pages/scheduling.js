...
Home.getInitialProps = async ({ query }) => {
  ...
  const locationMapping = [
    ...
    },
    {
      ...
      link:
        'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=78405&vt=2102&dept=103700024&view=plain&public=1'
    },
    {
    ...
    },
    {
      ...
      link:
        'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=78866&vt=2228&dept=100001318&view=plain&public=1'
    }
  ];

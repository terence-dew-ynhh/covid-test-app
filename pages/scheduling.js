...
Home.getInitialProps = async ({ query }) => {
  ...
  if (isimmunocomp == 'true') {
    link =
      'https://openscheduling.ynhhs.org/mychart-prd/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=90409,88040,88037,88046,88038,88042,88043,91671,91796,83564&vt=2444&dept=204010005,204400009,204590014,208040011,203260005,201120002,204530003,101450002,104010099,101870002&view=plain&public=1';
  }

...
Home.getInitialProps = async ({ query }) => {
  ...
  link =
    'https://openscheduling.ynhhs.org/mychart-prd/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=87700&vt=2293&dept=204680001&view=plain&public=1';

  if (jjapproved == 'true') {
    link =
      'https://openscheduling.ynhhs.org/mychart-prd/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=87702,87700&vt=2293&dept=204680001&view=plain&public=1';
  }
  ...
  if (second_dose == 'true') {
    ...
    if (isPfizer == 'true') {
      link =
        'https://openscheduling.ynhhs.org/mychart-prd/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=87701,84797,84800,84799,84796,85376,84816,84798,85109&vt=2339&dept=204680001,101960001,102340001,102350001,102360001,102370001,102380001,102390001,102400001&view=plain&public=1';
    }
  }

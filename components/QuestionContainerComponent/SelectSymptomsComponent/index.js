    ...
    <>
      <div className={styles.question_row_item}>
        <p className="error" hidden={!(hasSymptoms === 'Yes')}>
          ...
          others and call the contact tracing line at
          860-832-1910. If you are a faculty member or employee, notify your
          manager and leave work. If you are home, stay home. Call 860-832-3202

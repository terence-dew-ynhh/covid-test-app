import styles from './PathConsentComponent.module.css';
import { useState, useEffect } from 'react';

const PathConsentComponent = ({ nextPage, isPrevEnabled, isDoneEnabled,isStudent }) => {
    ...
    <>
      <div className={styles.question_row_item}>
        <div className={styles.question_row_item_sub}>
          <fieldset>
            <legend>
            You have chosen the <b><u>{ isStudent ? 'STUDENT': 'EMPLOYEE'}</u></b> testing pathway.  Please confirm that you are { isStudent ? 'a': 'an'} <b><u>{ isStudent ? 'STUDENT': 'EMPLOYEE'}</u></b>.
            </legend>
...
export default PathConsentComponent;

    ...
    <>
      <div className={styles.question_row_item}>
        <p className="error" hidden={!(hasSymptoms === 'Yes')}>
          If you have any of these symptoms and would like a COVID test, please
          call your primary care doctor. If you do not have a primary care
          doctor, please call the COVID-19 Call Center at 833-ASK-YNHH.
        </p>

...
Home.getInitialProps = async ({ query }) => {
  ...
  const urlList = {
    'Fairfield County and NY': {
      Symptomatic:
        'https://openscheduling.ynhhs.org/MyChart-PRD/openscheduling/standalone?id=78600,85142,76703,76698&vt=1946&dept=103010119,100001384,104010098,103010119&view=plain&public=1',
      Asymptomatic:
    ...
    'New London County': {
      Symptomatic:
        'https://openscheduling.ynhhs.org/MyChart-PRD/openscheduling/standalone?id=76701,82949&vt=1946&dept=108010101,100001383&view=plain&public=1',
      Asymptomatic:
    ...
    'New Haven County and Middlesex County': {
      Symptomatic:
        'https://openscheduling.ynhhs.org/MyChart-PRD/openscheduling/standalone?id=81079,88751,81452,82383,82948&vt=1946&dept=103720003,101130001,100001365,101050022,100001382,103010119&view=plain&public=1',
      Asymptomatic:

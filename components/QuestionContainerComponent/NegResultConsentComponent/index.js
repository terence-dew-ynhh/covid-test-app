...
const NegResultConsent = ({ nextPage, isPrevEnabled, isDoneEnabled }) => {
  ...
  let checkboxes = checkboxesArray.map((checkbox, idx) =>
      (<div className={styles.chk_row_item}>
        <label className={styles.none_label_or}>
          {' '}
          <b>Signature:</b><br></br>
            I certify that the information provided is correct to the best of my knowledge. I will not hold Yale New Haven Health, its health providers, or its employees responsible for any errors or omissions that I may have made in completing the information on this form. I hereby voluntarily consent to testing and release of information for my dependent or myself by Yale New Haven Health and authorize such testing (including, but not limited to the use of lab studies) which may have been ordered by its providers if I do not have an order already in hand.
        </label>
        <input

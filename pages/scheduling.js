...
Home.getInitialProps = async ({ query }) => {
  ...
  const urlList = {
    ...
    'New Haven County and Middlesex County': {
      ...
      Asymptomatic: {
        mandate:
          'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=81079,81452,82383,82948&vt=1380&dept=103720003,100001365,101050022,100001382&view=plain&public=1',
        travel:
          'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=81079,81452,82383,82948&vt=1380&dept=103720003,100001365,101050022,100001382&view=plain&public=1',
        exposure:
    ...
    'Washington RI County': {
      ...
      Asymptomatic: {
        mandate:
          'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=76702&vt=1380&dept=108710074&view=plain&public=1',
        travel:
          'https://mychart.ynhhs.org/MyChart-PRD/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=76702&vt=1380&dept=108710074&view=plain&public=1',
        exposure:
